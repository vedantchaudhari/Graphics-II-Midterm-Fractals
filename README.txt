...
4. Features
	...
	F. Animation
5. Using the animal3D Framework
...
-animal3D-SDK/ (root)					|
	...
	-animal3D-SDK/						| (you are here)
		...
		-LAUNCH_VS2015.bat				| Visual Studio 2015 launcher
		-include/						| 
			-animal3D/                  | Header and inline files live here
		-project/                       | 
			-VS2015/                    | 
				-_SLN/                  | 
					-animal3d-sdk/      | Visual Studio 2015 solution
...
3. Platform-specific information
	...
	A. Windows
		i.	 IDE: Visual Studio 2015
The supported IDE for Windows is VISUAL STUDIO 2015.
...
more of the components therein: 
		...
		iii. Notes
Hotloading demo code: 
When rebuilding project via command line, PDB file is not auto-unloaded. 
Change this Visual Studio setting to leave PDB files unlocked (minor 
implications on C++ projects, no notable effects in C): 
Tools > Options > Debugging > Use Native Compatibility > ENABLE 
(https://stackoverflow.com/questions/38427425/how-to-force-visual-studio-2015-to-unlock-pdb-file-after-freelibrary-call)

	B. Future Platforms 
A future version of the framework will include the necessary means to build 
animal3D projects using Xcode on Mac OS.
...
or warnings thrown by the library itself or external libraries.
	...
	B. Hotloaded Demo
The backbone of the windowed application is the ability to hotload your demos 
...
3.	To open the framework, run the batch file called "LAUNCH_VS2015.bat" in 
the root folder.
...
If any Intellisense problems occur, close the problem instance of Visual 
Studio and navigate to the solution directory and delete the Intellisense 
database file (.db): 
	"./projects/VS2015/_SLN/animal3D-sdk/animal3D-sdk.VC.db"
...
open a window; if you do not build first, your library may not update.
	
**DO NOT CHANGE ANY PROJECT SETTINGS** other than to add dependencies.
	
To prepare a package of your demo (e.g. a project submission), use the batch 
file "PACKAGE_VS2015.bat" in the root folder; just enter a name and it will 
copy all of the files to a new folder. Zip it up and you're golden!
