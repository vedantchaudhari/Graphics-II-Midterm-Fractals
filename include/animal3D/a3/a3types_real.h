...
/*
	...
	a3types_real.h
	Shorthand float type definitions and basic vector types.
*/
...
// vector base types and their pointers use intrinsic types
// also defines parameter and return types as pointers
...
// define vector base types and their pointers using arrays of real
// also defines parameter and return types as pointers
