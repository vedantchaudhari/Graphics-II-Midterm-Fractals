...
//-----------------------------------------------------------------------------
	...
	int a3modelLoadOBJ(a3_GeometryData *geom_out, const char *filePath, const a3_ModelLoaderFlag flags, const float *transform_opt);
	...
	//	return: 0 if failed
	//	return: -1 if invalid params
	int a3modelLoadOBJSkinWeights(a3_GeometryData *geom_out, const char *filePath, const a3_ModelLoaderFlag flags, const char *weightsFilePath, const char *influenceNames[], const unsigned int numInfluences, const float *transform_opt);
