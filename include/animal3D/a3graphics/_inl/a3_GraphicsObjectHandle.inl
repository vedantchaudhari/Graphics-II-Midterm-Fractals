...
inline int a3handleCreateHandle(a3_GraphicsObjectHandle *handle_out, const a3_GraphicsObjectReleaseFunc releaseFunc_opt, const unsigned int handleValue, const unsigned int objectCount)
{
	// if valid
...
inline int a3handleSetReleaseFunc(a3_GraphicsObjectHandle *handle, const a3_GraphicsObjectReleaseFunc releaseFunc_opt)
{
	if (handle)
	{
...
inline int a3handleIncrementCount(a3_GraphicsObjectHandle *handle)
{
...
inline int a3handleDecrementCount(a3_GraphicsObjectHandle *handle)
{
	// if valid
	if (handle && handle->handle)
	{
...
inline int a3handleRelease(a3_GraphicsObjectHandle *handle)
{
	// if valid
	if (handle && handle->handle)
	{
