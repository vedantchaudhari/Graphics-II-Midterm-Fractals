...
//-----------------------------------------------------------------------------
	...
	int a3vertexBufferStore(a3_VertexBuffer *vertexBuffer, const a3_VertexFormatDescriptor *vertexFormat, const a3_VertexAttributeDataDescriptor *attribRawData, const unsigned int vertexCount, unsigned int *offset_out_opt);
	...
	//	return: -1 if invalid params or improperly initialized params
	int a3indexBufferStore(a3_IndexBuffer *indexBuffer, const a3_IndexFormatDescriptor *indexFormat, const void *indexData, const unsigned int indexCount, const unsigned int baseIndex, unsigned int *offset_out_opt, const a3_IndexFormatDescriptor *internalFormat_opt);
...
//-----------------------------------------------------------------------------
	...
	int a3vertexArrayCreateDescriptor(a3_VertexArrayDescriptor *vertexArray_out, a3_VertexBuffer *vertexBuffer, const a3_VertexFormatDescriptor *vertexFormat, const unsigned int vertexBufferOffset);
	...
	int a3vertexArrayGetCurrentCount(const a3_VertexArrayDescriptor *vertexArray);
	...
	//	return: 0 if missing attribute descriptions or data, or out of space
	//	return: -1 if invalid params or improperly initialized params
	int a3vertexArrayStore(a3_VertexArrayDescriptor *vertexArray, const a3_VertexAttributeDataDescriptor *attribRawData, const unsigned int vertexCount, unsigned int *vertexBufferOffset_out_opt, unsigned int *firstVertex_out_opt);
	...
	int a3vertexArrayReferenceDescriptor(a3_VertexArrayDescriptor *vertexArray);
	...
	//	return: -1 if invalid param or not initialized
	int a3vertexArrayReleaseDescriptor(a3_VertexArrayDescriptor *vertexArray);
	...
	int a3vertexArrayHandleUpdateReleaseCallback(a3_VertexArrayDescriptor *vertexArray);
