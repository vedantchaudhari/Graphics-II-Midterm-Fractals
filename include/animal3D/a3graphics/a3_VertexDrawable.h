...
//-----------------------------------------------------------------------------
	...
	int a3vertexCreateDrawable(a3_VertexDrawable *drawable_out, a3_VertexArrayDescriptor *vertexArray, const a3_VertexPrimitiveType primitiveType, const unsigned int firstVertex, const unsigned int numVertices);
	...
	//	return: -1 if invalid params or improperly initialized params
	int a3vertexCreateDrawableIndexed(a3_VertexDrawable *drawable_out, a3_VertexArrayDescriptor *vertexArray, a3_IndexBuffer *indexBuffer, const a3_IndexFormatDescriptor *indexFormat, const a3_VertexPrimitiveType primitiveType, const unsigned int firstIndexByteOffset, const unsigned int numIndices);
	...
	int a3vertexActivateDrawable(const a3_VertexDrawable *drawable);

	// A3: Deactivate any active drawable.
	//	return: 0
	int a3vertexDeactivateDrawable();

	// A3: Render active drawable.
	//	return: 1 if rendered
	//	return: 0 if no drawable active
	int a3vertexRenderActiveDrawable();
	...
	int a3vertexRenderActiveDrawableInstanced(const unsigned int instanceCount);
	...
	//	return: 0 if deactivated
	int a3vertexActivateAndRenderDrawable(const a3_VertexDrawable *drawable);
	...
	//	return: 1 if activated and rendered
	//	return: 0 if deactivated
	int a3vertexActivateAndRenderDrawableInstanced(const a3_VertexDrawable *drawable, const unsigned int instanceCount);
	...
	int a3vertexReferenceDrawable(a3_VertexDrawable *drawable);
	...
	//	return: -1 if invalid param or not initialized
	int a3vertexReleaseDrawable(a3_VertexDrawable *drawable);
