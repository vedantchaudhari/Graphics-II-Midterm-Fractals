...
//-----------------------------------------------------------------------------
	...
	int a3mouseGetState(const a3_MouseInput *mouse, const a3_MouseButton button);
	...
	//	return: a3input_invalid if invalid params
	int a3mouseGetStateWheel(const a3_MouseInput *mouse);
	...
	//	return: a3input_invalid if invalid params
	int a3mouseIsHeld(const a3_MouseInput *mouse, const a3_MouseButton button);
	...
	//	return: a3input_invalid if invalid params
	int a3mouseSetState(a3_MouseInput *mouse, const a3_MouseButton button, const a3_InputState state);
	...
	//	return: a3input_invalid if invalid params
	int a3mouseSetStateWheel(a3_MouseInput *mouse, const a3_MouseWheelState delta);
	...
	//	return: 1 if success
	//	return: a3input_invalid if invalid params
	int a3mouseSetPosition(a3_MouseInput *mouse, const int x, const int y);

	// A3: Update mouse state.
	//	param mouse: non-null pointer to mouse state descriptor
	//	return:	1 if success
	//	return: a3input_invalid if invalid param
	int a3mouseUpdate(a3_MouseInput *mouse);

	// A3: Reset current mouse state.
	//	param mouse: non-null pointer to mouse state descriptor
	//	return:	1 if success
	//	return: a3input_invalid if invalid param
	int a3mouseReset(a3_MouseInput *mouse);
