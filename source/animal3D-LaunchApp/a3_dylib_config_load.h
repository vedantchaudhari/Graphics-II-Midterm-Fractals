...
// A3 load library
inline A3DYLIBHANDLE a3dylibLoad(const char *libPath)
{
	return A3DYLIBLOAD(libPath);
}

// A3 unload library
inline int a3dylibUnload(A3DYLIBHANDLE libHandle)
{
	return A3DYLIBUNLOAD(libHandle);
}

// A3 get symbol
inline A3DYLIBSYMBOL a3dylibGetSymbol(A3DYLIBHANDLE libHandle, const char *symbolName)
{
