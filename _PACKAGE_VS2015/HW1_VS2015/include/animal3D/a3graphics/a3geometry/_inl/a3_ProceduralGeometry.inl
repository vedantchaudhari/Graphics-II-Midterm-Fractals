...
inline int a3proceduralGetDescriptorFlags(const a3_ProceduralGeometryDescriptor *geom)
{
	if (geom && geom->shape)
...
inline int a3proceduralGetDescriptorAxis(const a3_ProceduralGeometryDescriptor *geom)
{
	if (geom && geom->shape)
