...
//-----------------------------------------------------------------------------
	...
	int a3proceduralCreateDescriptorTriangle(a3_ProceduralGeometryDescriptor *geom_out, const a3_ProceduralGeometryFlag flags, const a3_ProceduralGeometryAxis axis, float base, float height);
	...
	//	return: 0 if failed
	//	return: -1 if invalid params
	int a3proceduralCreateDescriptorCircle(a3_ProceduralGeometryDescriptor *geom_out, const a3_ProceduralGeometryFlag flags, const a3_ProceduralGeometryAxis axis, float radius, unsigned char slices, unsigned char subdivsBaseRings);
	...
	//	return: 0 if failed
	//	return: -1 if invalid params
	int a3proceduralCreateDescriptorPlane(a3_ProceduralGeometryDescriptor *geom_out, const a3_ProceduralGeometryFlag flags, const a3_ProceduralGeometryAxis axis, float width, float height, unsigned char subdivsW, unsigned char subdivsH);
	...
	//	return: 0 if failed
	//	return: -1 if invalid params
	int a3proceduralCreateDescriptorPyramid(a3_ProceduralGeometryDescriptor *geom_out, const a3_ProceduralGeometryFlag flags, const a3_ProceduralGeometryAxis axis, float width, float length);
	...
	//	return: 0 if failed
	//	return: -1 if invalid params
	int a3proceduralCreateDescriptorOctahedron(a3_ProceduralGeometryDescriptor *geom_out, const a3_ProceduralGeometryFlag flags, const a3_ProceduralGeometryAxis axis, float width, float length);
	...
	//	return: 0 if failed
	//	return: -1 if invalid params
	int a3proceduralCreateDescriptorBox(a3_ProceduralGeometryDescriptor *geom_out, const a3_ProceduralGeometryFlag flags, float width, float height, float length, unsigned char subdivsW, unsigned char subdivsH, unsigned char subdivsL);
	...
	//	return: 0 if failed
	//	return: -1 if invalid params
	int a3proceduralCreateDescriptorSemisphere(a3_ProceduralGeometryDescriptor *geom_out, const a3_ProceduralGeometryFlag flags, const a3_ProceduralGeometryAxis axis, float radius, unsigned char slices, unsigned char stacks, unsigned char subdivsBaseRings);
	...
	//	return: 0 if failed
	//	return: -1 if invalid params
	int a3proceduralCreateDescriptorSphere(a3_ProceduralGeometryDescriptor *geom_out, const a3_ProceduralGeometryFlag flags, const a3_ProceduralGeometryAxis axis, float radius, unsigned char slices, unsigned char stacks);
	...
	//	return: 0 if failed
	//	return: -1 if invalid params
	int a3proceduralCreateDescriptorCone(a3_ProceduralGeometryDescriptor *geom_out, const a3_ProceduralGeometryFlag flags, const a3_ProceduralGeometryAxis axis, float radius, float length, unsigned char slices, unsigned char subdivsL, unsigned char subdivsBaseRings);
	...
	//	return: 0 if failed
	//	return: -1 if invalid params
	int a3proceduralCreateDescriptorDiamond(a3_ProceduralGeometryDescriptor *geom_out, const a3_ProceduralGeometryFlag flags, const a3_ProceduralGeometryAxis axis, float radius, float length, unsigned char slices, unsigned char subdivsPerHalfL);
	...
	//	return: 0 if failed
	//	return: -1 if invalid params
	int a3proceduralCreateDescriptorCylinder(a3_ProceduralGeometryDescriptor *geom_out, const a3_ProceduralGeometryFlag flags, const a3_ProceduralGeometryAxis axis, float radius, float length, unsigned char slices, unsigned char subdivsL, unsigned char subdivsBaseRings);
	...
	//	return: 0 if failed
	//	return: -1 if invalid params
	int a3proceduralCreateDescriptorCapsule(a3_ProceduralGeometryDescriptor *geom_out, const a3_ProceduralGeometryFlag flags, const a3_ProceduralGeometryAxis axis, float radius, float lengthBody, unsigned char slices, unsigned char stacksCap, unsigned char subdivsL);
	...
	//	return: 0 if failed
	//	return: -1 if invalid params
	int a3proceduralCreateDescriptorTorus(a3_ProceduralGeometryDescriptor *geom_out, const a3_ProceduralGeometryFlag flags, const a3_ProceduralGeometryAxis axis, float radiusMajor, float radiusMinor, unsigned char slices, unsigned char subdivsR);
	...
	//	return: 0 if failed
	//	return: -1 if invalid params
	int a3proceduralCreateDescriptorAxes(a3_ProceduralGeometryDescriptor *geom_out, const a3_ProceduralGeometryFlag flags, float thickness, const char color);
...
//-----------------------------------------------------------------------------
	...
	//	return: -1 if invalid params
	int a3proceduralGetDescriptorFlags(const a3_ProceduralGeometryDescriptor *geom);

	// A3: Get the axis direction from a shape descriptor.
	//	param geom: non-null pointer to initialized descriptor
	//	return: axis direction (see enum)
	//	return: -1 if invalid params
	int a3proceduralGetDescriptorAxis(const a3_ProceduralGeometryDescriptor *geom);
	...
	//	return: 1 if success
	//	return: -1 if invalid params
	int a3proceduralSetDescriptorFlags(a3_ProceduralGeometryDescriptor *geom, const a3_ProceduralGeometryFlag flags);
	...
	//	return: -1 if invalid params
	int a3proceduralSetDescriptorAxis(a3_ProceduralGeometryDescriptor *geom, const a3_ProceduralGeometryAxis axis);
	...
	//	return: 0 if shape does not use axis
	//	return: -1 if invalid params
	int a3proceduralSetDescriptorFlagsAxis(a3_ProceduralGeometryDescriptor *geom, const a3_ProceduralGeometryFlag flags, const a3_ProceduralGeometryAxis axis);
...
//-----------------------------------------------------------------------------
	...
	//	return: 1 if success
	//	return: -1 if invalid params
	int a3proceduralGenerateGeometryData(a3_GeometryData *geomData_out, const a3_ProceduralGeometryDescriptor *geom);
