...
//-----------------------------------------------------------------------------
	...
	{
		unsigned short attribType[a3attrib_nameMax];
		unsigned short attribOffset[a3attrib_nameMax];
		unsigned char attribElements[a3attrib_nameMax];
		unsigned char attribSize[a3attrib_nameMax];
		unsigned short vertexSize;
		unsigned short vertexNumAttribs;
	};
...
//-----------------------------------------------------------------------------
	...
	int a3vertexAttribGetElementsPerAttrib(const a3_VertexAttributeType attribType);
	...
	int a3vertexAttribGetBytesPerElement(const a3_VertexAttributeType attribType);
	...
	int a3indexGetBytesPerIndex(const a3_IndexType indexType);
	...
	int a3vertexStorageSpaceRequired(const a3_VertexFormatDescriptor *vertexFormat, const unsigned int count);
	...
	//	return: storage space requirements in bytes
	//	return: -1 if invalid param
	int a3indexStorageSpaceRequired(const a3_IndexFormatDescriptor *indexFormat, const unsigned int count);
...
//-----------------------------------------------------------------------------
	...
	int a3vertexAttribCreateDescriptor(a3_VertexAttributeDescriptor *attrib_out, const a3_VertexAttributeName attribName, const a3_VertexAttributeType attribType);
	...
	//	return: 1 if success
	//	return: -1 if invalid params
	int a3vertexAttribDataCreateDescriptor(a3_VertexAttributeDataDescriptor *attrib_out, const a3_VertexAttributeName attribName, const void *attribData);
	...
	//	return: -1 if invalid params
	int a3vertexCreateFormatDescriptor(a3_VertexFormatDescriptor *vertexFormat_out, const a3_VertexAttributeDescriptor *attribList, unsigned int attribCount);
	...
	//	return: -1 if invalid params
	int a3indexCreateFormatDescriptor(a3_IndexFormatDescriptor *indexFormat_out, const a3_IndexType indexType);
	...
	//	return: -1 if invalid param
	int a3vertexFormatHasAttribute(const a3_VertexFormatDescriptor *vertexFormat, const a3_VertexAttributeName attribName);
	...
	//	return: -1 if invalid param
	int a3indexFormatIsActive(const a3_IndexFormatDescriptor *indexFormat);
