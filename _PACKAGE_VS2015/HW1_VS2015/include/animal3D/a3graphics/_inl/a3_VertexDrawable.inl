...
inline int a3vertexReferenceDrawable(a3_VertexDrawable *drawable)
{
	if (drawable && drawable->vertexArray)
	{
		int ret = a3vertexArrayReferenceDescriptor(drawable->vertexArray);
...
inline int a3vertexReleaseDrawable(a3_VertexDrawable *drawable)
{
	if (drawable && drawable->vertexArray)
	{
		int ret = a3vertexArrayReleaseDescriptor(drawable->vertexArray);
