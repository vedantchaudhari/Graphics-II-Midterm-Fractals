...
inline int a3framebufferReference(a3_Framebuffer *framebuffer)
{
	if (framebuffer)
...
inline int a3framebufferRelease(a3_Framebuffer *framebuffer)
{
	if (framebuffer)
	{
		int ret = a3handleDecrementCount(framebuffer->handle);
		if (ret == 0)
...
inline int a3framebufferDoubleSwap(a3_FramebufferDouble *framebufferDouble)
{
...
inline int a3framebufferDoubleReference(a3_FramebufferDouble *framebufferDouble)
{
...
inline int a3framebufferDoubleRelease(a3_FramebufferDouble *framebufferDouble)
{
	if (framebufferDouble)
	{
		int ret = a3handleDecrementCount(framebufferDouble->handle);
		if (ret == 0)
		{
			// reset
