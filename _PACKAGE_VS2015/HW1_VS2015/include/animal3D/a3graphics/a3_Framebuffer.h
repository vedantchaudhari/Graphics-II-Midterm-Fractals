...
//-----------------------------------------------------------------------------
	...
	struct a3_Framebuffer
	{
		struct {
			...
			unsigned int colorTextureHandle[a3fbo_colorTargetMax];
			unsigned int depthTextureHandle[1];
		};
		unsigned short frameWidth, frameHeight;
		unsigned short color, depthStencil;
	};
	...
	struct a3_FramebufferDouble
	{
		struct {
			a3_GraphicsObjectHandle handle[1];
			unsigned int handleDouble;
			unsigned int colorTextureHandle[a3fbo_colorTargetMax*2];
			unsigned int depthTextureHandle[2];
		};
		unsigned short frontColor, frontDepth;
		unsigned short frameWidth, frameHeight;
		unsigned short color, depthStencil;
	};
...
//-----------------------------------------------------------------------------
	...
	int a3framebufferCreate(a3_Framebuffer *framebuffer_out, unsigned int colorTargets, const a3_FramebufferColorType colorType, const a3_FramebufferDepthType depthType, const unsigned short frameWidth, const unsigned short frameHeight);
	...
	int a3framebufferActivate(const a3_Framebuffer *framebuffer);

	// A3: Deactivate any active framebuffer (also applies to double-buffer).
	//	return: 0
	int a3framebufferDeactivate();
	...
	//	return: 0
	int a3framebufferDeactivateSetViewport(const a3_FramebufferDepthType depthType, const int viewportPosX, const int viewportPosY, const unsigned int viewportWidth, const unsigned int viewportHeight);
	...
	int a3framebufferBindColorTexture(const a3_Framebuffer *framebuffer, const a3_TextureUnit unit, const unsigned int colorTarget);
	...
	//	return: 1 if success
	//	return: -1 if invalid params or not initialized
	int a3framebufferBindDepthTexture(const a3_Framebuffer *framebuffer, const a3_TextureUnit unit);

	// A3: Reference framebuffer.
	//	param framebuffer: non-null pointer to initialized framebuffer
	//	return: new reference count if success
	//	return: -1 if invalid params or not initialized
	int a3framebufferReference(a3_Framebuffer *framebuffer);
	...
	//	return: -1 if invalid params or not initialized
	int a3framebufferRelease(a3_Framebuffer *framebuffer);
	...
	int a3framebufferHandleUpdateReleaseCallback(a3_Framebuffer *framebuffer);
...
//-----------------------------------------------------------------------------
	...
	//	return: 0 if failed
	//	return: -1 if invalid params (null pointer or already initialized)
	int a3framebufferDoubleCreate(a3_FramebufferDouble *framebufferDouble_out, unsigned int colorTargets, const a3_FramebufferColorType colorType, const a3_FramebufferDepthType depthType, const unsigned short frameWidth, const unsigned short frameHeight);
	...
	//	return: 0 if deactivated
	//	return: -1 if invalid params or not initialized
	int a3framebufferDoubleActivate(const a3_FramebufferDouble *framebufferDouble);
	...
	//	return: 1 if success
	//	return: -1 if invalid params or not initialized
	int a3framebufferDoubleBindColorTexture(const a3_FramebufferDouble *framebufferDouble, const a3_TextureUnit unit, const unsigned int colorTarget);
	...
	//	return: 1 if success
	//	return: -1 if invalid params or not initialized
	int a3framebufferDoubleBindDepthTexture(const a3_FramebufferDouble *framebufferDouble, const a3_TextureUnit unit);
	...
	//	return: 1 if success
	//	return: -1 if invalid params or not initialized
	int a3framebufferDoubleSwap(a3_FramebufferDouble *framebufferDouble);

	// A3: Reference double-buffering framebuffer.
	//	param framebufferDouble: non-null pointer to initialized framebuffer
	//	return: new reference count if success
	//	return: -1 if invalid params or not initialized
	int a3framebufferDoubleReference(a3_FramebufferDouble *framebufferDouble);
	...
	//	return: 0 if object was permanently released; descriptor is reset
	//	return: -1 if invalid params or not initialized
	int a3framebufferDoubleRelease(a3_FramebufferDouble *framebufferDouble);
	...
	//	return: 1 if updated
	//	return: -1 if invalid param
	int a3framebufferDoubleHandleUpdateReleaseCallback(a3_FramebufferDouble *framebufferDouble);
