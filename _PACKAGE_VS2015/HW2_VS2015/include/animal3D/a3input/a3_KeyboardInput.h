...
//-----------------------------------------------------------------------------
	...
	//		callback; if a key can be represented by a character, use a literal 
	//		char (e.g. 'a') with the keyChar callback; otherwise, use one of 
	//		these codes to check the state of an ascii key.
...
//-----------------------------------------------------------------------------
	...
	int a3keyboardGetState(const a3_KeyboardInput *keyboard, const a3_KeyboardKey key);
	...
	//	return: a3input_invalid if invalid params
	int a3keyboardIsHeld(const a3_KeyboardInput *keyboard, const a3_KeyboardKey key);
	...
	//	return: a3input_invalid if invalid params
	int a3keyboardIsChanged(const a3_KeyboardInput *keyboard, const a3_KeyboardKey key);
	...
	//	return: 0 if key is not pressed
	//	return: a3input_invalid if invalid params
	int a3keyboardGetStateASCII(const a3_KeyboardInput *keyboard, const char key);
	...
	//	return: 0 if key is not down or has changed
	//	return: a3input_invalid if invalid params
	int a3keyboardIsHeldASCII(const a3_KeyboardInput *keyboard, const char key);
	...
	//	return: 0 if key did not change
	//	return: a3input_invalid if invalid params
	int a3keyboardIsChangedASCII(const a3_KeyboardInput *keyboard, const char key);
	...
	int a3keyboardGetDifference(const a3_KeyboardInput *keyboard, const a3_KeyboardKey keyPositive, const a3_KeyboardKey keyNegative);
	...
	//	return: -1 if negative key is down and positive key is up
	//	return: 0 if both keys have the same state
	int a3keyboardGetDifferenceASCII(const a3_KeyboardInput *keyboard, const char keyPositive, const char keyNegative);
	...
	//	return: a3input_invalid if invalid params
	int a3keyboardSetState(a3_KeyboardInput *keyboard, const a3_KeyboardKey key, const a3_InputState state);
	...
	//	return:	new key state
	//	return: a3input_invalid if invalid params
	int a3keyboardSetStateASCII(a3_KeyboardInput *keyboard, const char key);

	// A3: Update keyboard state.
	//	param keyboard: non-null pointer to keyboard state descriptor
	//	return:	1 if success
	//	return: a3input_invalid if invalid param
	int a3keyboardUpdate(a3_KeyboardInput *keyboard);

	// A3: Reset current keyboard state
	//	param keyboard: non-null pointer to keyboard state descriptor
	//	return: 1 if success
	//	return: a3input_invalid if invalid param
	int a3keyboardReset(a3_KeyboardInput *keyboard);
