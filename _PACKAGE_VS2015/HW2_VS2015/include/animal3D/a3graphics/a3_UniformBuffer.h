...
//-----------------------------------------------------------------------------
	...
	int a3shaderUniformBufferActivate(const a3_UniformBuffer *buffer, const unsigned int unifBlockBinding);
	...
	int a3shaderUniformBlockBind(const a3_ShaderProgram *program, const unsigned int unifBlockBinding, const int unifBlockLocation);
	...
	int a3shaderUniformBlockMaxCount(const a3_ShaderType shaderType);
